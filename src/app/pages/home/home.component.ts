...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  readonly propertyTypes = [
    {
      titleKey: 'prop.luxuryTitle',
      image: 'assets/images/borey-vimean-bg.jpg',
      typeKey: 'prop.luxuryType',
      size: '320-480 sqm',
      purposeKey: 'prop.luxuryPurpose',
      descriptionKey: 'prop.luxuryDesc',
      rating: 5,          
      isFavorite: true
    },
    {
      titleKey: 'prop.modernTitle',
      image: 'assets/images/property_list1.jpg',
      typeKey: 'prop.modernType',
      size: '220-300 sqm',
      purposeKey: 'prop.modernPurpose',
      descriptionKey: 'prop.modernDesc',
      rating: 5,           
      isFavorite: true
    },
    // រាល់ប្រភេទផ្ទះ Shophouse ទាំងអស់គឺប្រើ Key រួមគ្នាដើម្បីកុំឱ្យជាន់កូដច្រើនដង
    {
      titleKey: 'prop.shopTitle',
      image: 'assets/images/house3.jpg',
      typeKey: 'prop.shopType',
      size: '180-260 sqm',
      purposeKey: 'prop.shopPurpose',
